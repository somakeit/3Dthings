...
module WadesS(){
	difference(){
		gear (number_of_teeth=10,
			...
			bore_diameter = 5.25,
			circles=0);
		translate([0,-5,20])cube([6.2,3,9],center = true);
		translate([0,0,17])rotate([0,90,-90])rotate(30)cylinder(r=1.7,h=20);
		translate([0,-5,17])rotate([0,90,-90])cylinder(r=6.2/2/cos(30),h=3,$fn=6,center=true);
	}
}
